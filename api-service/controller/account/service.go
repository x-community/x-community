...
// @Tags Account
// @ID account_register
// @Param	input 	body		account.registerRequest		true		"request"
...
func (s *service) Register(ctx *gin.Context) {
	...
	_, err := s.userService.Register(s.TracerContext(ctx), &pb.RegisterRequest{Email: req.Email, Username: req.Username, Password: req.Password}, client.WithRequestTimeout(time.Minute))
	if err != nil {
		s.Error(ctx, err)
		return
	}
...
// @Tags Account
// @ID account_verify
// @Param	input 	body		account.verifyAccountRequest	true		"request"
// @Success 200 	{object}	api.SuccessResponse			"success"
// @Failure 400 	{object}	api.ErrorResponse
// @Failure 500		{object}	api.ErrorResponse
...
// @Tags Account
// @ID account_login
// @Param	input 	body		account.loginRequest	true	"request"
// @Success 200 	{object}	account.loginResponse			"success"
