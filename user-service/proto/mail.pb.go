...
func (x *SendMailRequest) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *SendMailRequest) GetContentType() string {
	if x != nil {
...
var file_mail_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x6d, 0x61, 0x69, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9e, 0x01, 0x0a,
	...
	0x65, 0x32, 0x40, 0x0a, 0x0b, 0x4d, 0x61, 0x69, 0x6c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x31, 0x0a, 0x08, 0x53, 0x65, 0x6e, 0x64, 0x4d, 0x61, 0x69, 0x6c, 0x12, 0x10, 0x2e, 0x53,
	0x65, 0x6e, 0x64, 0x4d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x11,
	0x2e, 0x53, 0x65, 0x6e, 0x64, 0x4d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x00, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x3b, 0x63, 0x6f, 0x6d, 0x6d, 0x75, 0x6e, 0x69,
...
var file_mail_proto_goTypes = []interface{}{
	(*SendMailRequest)(nil),  // 0: SendMailRequest
	(*SendMailResponse)(nil), // 1: SendMailResponse
}
var file_mail_proto_depIdxs = []int32{
	0, // 0: MailService.SendMail:input_type -> SendMailRequest
	1, // 1: MailService.SendMail:output_type -> SendMailResponse
